	...
	return (
		<TableRow className="border-collapse border-b border-slate-500">
			<TableCell>
				<Dialog>
					<DialogTrigger>
						<Button className="border border-primary hover:text-background">View</Button>
					</DialogTrigger>
					<DialogContent>
						<DialogHeader>
			...
			<TableCell className="font-medium overflow-hidden hover:overflow-visible min-w-fit text-left">{appointment.apptid}</TableCell>
			...
			<TableCell className="w-fit text-nowrap text-left capitalize">{appointment.patient_gender === 'FEMALE' ? 'Female' : 'Male'}</TableCell>
			<TableCell className="w-fit text-nowrap text-left capitalize">{appointment.doctor_mainspecialty}</TableCell>
			...
			<TableCell className="w-fit text-nowrap text-left capitalize">{appointment.hospital_name}</TableCell>
			...
			<TableCell className="w-fit text-nowrap text-left capitalize">{appointment.region}</TableCell>
		</TableRow>
	)
}
